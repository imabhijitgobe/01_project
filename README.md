...
- 🤖 **AI-Powered Commits** - Generate professional commit messages using Gemini, OpenAI, Anthropic, or GitHub
- 🔐 **Smart Authentication** - Automatic GitHub CLI installation and authentication flow
- 📦 **Repository Management** - List, create, and delete GitHub repositories
- ⚡ **One Command Push** - Stage, commit with AI, and push in a single command
- 🔧 **Easy Configuration** - Interactive setup with secure API key storage
...
1. ✅ Check if GitHub CLI is installed (install if missing)
2. ✅ Authenticate with GitHub
3. ✅ Set up your AI provider
4. ✅ Create a GitHub repository (if needed)
...
```
📂 Your GitHub Repositories (showing 10):
...
⚠️ **Warning:** This action is irreversible. The repository will be permanently deleted from GitHub.
...
<p align="center">
  Made with ❤️ by <a href="https://github.com/imabhijitgobe">Abhijit Gobe</a>
</p>
